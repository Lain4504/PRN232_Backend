...
## 🧪 API Testing nhanh trên Swagger

Bạn có thể test các API chính trực tiếp trên Swagger UI. Mở ứng dụng và truy cập `http://localhost:5283/swagger`, click "Authorize" để nhập JWT nếu endpoint yêu cầu.
