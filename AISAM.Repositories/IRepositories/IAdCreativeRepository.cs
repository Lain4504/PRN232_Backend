...
namespace AISAM.Repositories.IRepositories
{
    public interface IAdCreativeRepository
    {
        ...
        Task<(IEnumerable<AdCreative> Data, int TotalCount)> GetAllPagedAsync(List<Guid> brandIds, int page, int pageSize, string? search = null, string? type = null, string? sortBy = null, string? sortOrder = null);
