...
namespace AISAM.Services.IServices
{
    ...
    {
        Task<GenericResponse<PayOSCheckoutResponse>> CreatePaymentLinkAsync(CreatePaymentIntentRequest request, Guid userId, Guid profileId);
        Task<GenericResponse<PaymentResponseDto>> ConfirmPaymentAsync(long orderCode, Guid userId);
        ...
        Task<GenericResponse<bool>> HandleWebhookAsync(string json, string signature);
