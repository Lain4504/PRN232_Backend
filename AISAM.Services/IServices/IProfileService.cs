...
namespace AISAM.Services.IServices
{
    public interface IProfileService
    {
        ...
        Task<GenericResponse<ProfileResponseDto>> GetProfileByIdIncludingDeletedAsync(Guid id, CancellationToken cancellationToken = default);
        ...
        Task<GenericResponse<IEnumerable<ProfileResponseDto>>> SearchUserProfilesAsync(Guid userId, string? searchTerm = null, CancellationToken cancellationToken = default);
        ...
        Task<GenericResponse<bool>> PermanentDeleteProfileAsync(Guid id, CancellationToken cancellationToken = default);
    }
}