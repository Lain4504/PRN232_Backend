...
{
    public class CreateAdCreativeFromFacebookPostRequestValidator : AbstractValidator<CreateAdCreativeFromFacebookPostRequest>
    {
        public CreateAdCreativeFromFacebookPostRequestValidator()
        {
            ...
            RuleFor(x => x.FacebookPostId)
                .NotEmpty()
                .WithMessage("Facebook post ID is required")
                .MaximumLength(255)
                .WithMessage("Facebook post ID cannot exceed 255 characters");
